...
//if condition ture then executed-> resolve() . And we can use -> then() for chaining another function task we can call .
...
// promise create : var promise-1 = new Promise( (resole, reject) => { });
...
// ----------------------------------------------------------
// Promise.race => if we have more promise then promise.raice() function will only work for 1 resolve () function which is completed with fast time among all promise...
